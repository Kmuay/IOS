...
class GoodsViewController: UIViewController,UITextFieldDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate
{
    ...
    override func viewDidLoad() {
        ...
        if let temp = goods {
            navigationItem.title = temp.name
            nameTextField.text = temp.name
            photoImageView.image = temp.photo
            ratingControl.rating = temp.rating
        }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        goods = Goods(name: name, photo: photo, rating: rating)
    }
    
    //MARK: Actions
    @IBAction func selectImageFromPhotoLibrary(_ sender: UITapGestureRecognizer) {
        
        print("someting is bad")
        // Hide the keyboard.
